...
class Wechat
{
    ...
    const MERCHANT_PRODUCT_CREATE = '/merchant/create';//增加商品
    const MERCHANT_PRODUCT_UPDATE = '/merchant/update';//修改商品
    const MERCHANT_PRODUCT_DEL = '/merchant/del';//删除商品
    const MERCHANT_PRODUCT_GET = '/merchant/get';//查询商品
    const MERCHANT_RODUCTSTATUS_GET = '/merchant/getbystatus';//获取指定状态的所有商品
    const MERCHANT_PRODUCTSTATUS_MODIFY = '/merchant/modproductstatus';//商品上下架
    const MERCHANT_CATEGORY_GET = '/merchant/category/getsub';//获取指定分类的所有子分类
    const MERCHANT_CATEGORY_GETPROPERTY = '/merchant/category/getproperty';//获取指定分类的所有属性
    const MERCHANT_STOCK_ADD = '/merchant/stock/add';//增加库存
    const MERCHANT_STOCK_REDUCE = '/merchant/stock/reduce';//减少库存
    const MERCHANT_EXPRESS_ADD = '/merchant/express/add';//增加邮费模板
    const MERCHANT_EXPORESS_UPDATE = '/merchant/express/update';//修改邮费模板
    const MERCHANT_EXPRESS_DEL = '/merchant/express/del';//删除邮费模板
    const MERCHANT_EXPRESS_GET = '/merchant/express/getbyid';//获取指定ID的邮费模板
    const MERCHANT_EXPRESS_GETALL = '/merchant/express/getall';//获取所有邮费模板
    const MERCHANT_UPLOAD_IMG = '/merchant/common/upload_img';//上传图片
    const MARCHANT_GROUP_ADD = '/merchant/group/add';//增加分组
    const MARCHANT_GROUP_DEL = '/merchant/group/del';//删除分组
    const MARCHANT_GROUP_PROPERTY_UPDATE = '/merchant/group/propertymod';//修改分组属性
    const MARCHANT_GROUP_PRODUCT_UPDATE = '/merchant/group/productmod';//修改分组商品
    const MARCHANT_GROUP_GETALL = '/merchant/group/getall';//获取所有分组
    const MARCHANT_GROUP_GET = '/merchant/group/getbyid';//根据分组ID获取分组信息
    const MARCHANT_SHELF_ADD = '/merchant/shelf/add';//增加货架
    const MARCHANT_SHELF_DEL = '/merchant/shelf/del';//删除货架
    const MARCHANT_SHELF_UPDATE = '/merchant/shelf/mod';//修改货架
    const MARCHANT_SHELF_GETALL = '/merchant/shelf/getall';//获取所有货架
    const MARCHANT_SHELF_GET = '/merchant/shelf/getbyid';//根据货架ID获取货架信息
    //微信门店
    const POI_GET = '/poi/getpoi';
    const POI_ADD = '/poi/addpoi';
    const POI_DEL = '/poi/delpoi';
    const POI_UPDATE = '/poi/updatepoi';
    const POI_GETLIST = '/poi/getpoilist';
    ...
    //现金红包
    const SENDREDPACK = '/mmpaymkttransfers/sendredpack';
    const GETHBINFO = '/mmpaymkttransfers/gethbinfo';
    const SENDGROUPREDPACK = '/mmpaymkttransfers/sendgroupredpack';
    //代金券
    const QUERY_COUPON_STOCK = '/mmpaymkttransfers/query_coupon_stock';
    const SEND_COUPON = '/mmpaymkttransfers/send_coupon';
    //企业付款
    const PROMOTION_TRANSFERS = '/mmpaymkttransfers/promotion/transfers';
    private $mch_appid;
    private $mchid;
    private $device_info;
    ...
    public function __construct($options)
    {
        ...
        $this->mchid = $this->mch_id;
        $this->key = isset($options['key']) ? $options['key'] : '';
        $this->mch_appid = isset($options['mch_appid']) ? $options['mch_appid'] : '';
        $this->device_info = isset($options['device_info']) ? $options['device_info'] : '';
    }
