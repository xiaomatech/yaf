...
class XingeApp
{
    ...
    {
        $qqpush_config = Yaconf::get('common')['qqpush'];
        assert(isset($qqpush_config['accessId']) && isset($qqpush_config['secretKey']));

        $this->accessId = $qqpush_config['accessId'];
        $this->secretKey = $qqpush_config['secretKey'];
    }
